...
class KIEntity(Entity):
    ...
    def __init__(self, runtime, key, name, icon):
        ...
        self._attr_device_info = DeviceInfo(identifiers={(DOMAIN,runtime.entry.entry_id)}, name=runtime.cfg['name'], manufacturer='KI', model='Varslinger og sikkerhet', sw_version='2.0.0')
