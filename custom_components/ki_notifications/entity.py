...
class KIEntity(Entity):
    ...
    def __init__(self, runtime, key, name, icon):
        ...
        self._attr_device_info = DeviceInfo(identifiers={(DOMAIN,runtime.entry.entry_id)}, name=runtime.cfg['name'], manufacturer='KI', model='Notifications', sw_version='1.2.0')
